    ...
    try {
        ...
        for (const p of productsList) {
            ...
            results.push({
                ...
                permalink: p.linkText ? `https://www.chedraui.com.mx/${p.linkText}/p?sku=${items[0].itemId}` : null,
                free_shipping: false,
                seller: 'Chedraui',
                brand: p.brand || '',
    ...
    try {
        ...
        for (const p of productsList) {
            ...
            results.push({
                ...
                list_price: listPrice,
                thumbnail: (items[0].images?.[0]?.imageUrl) || 'https://via.placeholder.com/150',
                permalink: p.linkText ? `https://www.heb.com.mx/${p.linkText}/p?sku=${items[0].itemId}` : null,
                free_shipping: false,
                seller: 'HEB',
                brand: p.brand || '',
                sku_id: items[0].itemId || '',
